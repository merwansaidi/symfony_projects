...
class __TwigTemplate_d8c72a1aa2d4ae8bcf1cb322d1a00136fa861e10c51ea3f1a47b9a359f401516 extends Template
{
    ...
    .example-wrapper code { background: #008080; padding: 2px 6px; }
</style>
...
<div>
  ...
  ";
        // line 26
        if ( !twig_test_empty((isset($context["paniers"]) || array_key_exists("paniers", $context) ? $context["paniers"] : (function () { throw new RuntimeError('Variable "paniers" does not exist.', 26, $this->source); })()))) {
            // line 27
            echo "  ";
      ...
      <tr>
        ...
        <td>";
                // line 30
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["panier"], "quantite", [], "any", false, false, false, 30), "html", null, true);
                echo "</td>
        <td>";
                // line 31
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["panier"], "produit", [], "any", false, false, false, 31), "prix", [], "any", false, false, false, 31), "html", null, true);
                echo "</td>
        <td>Delete</td>
      </tr>
  ";
...
";
    ...
    {
        return array (  147 => 44,  141 => 36,  138 => 35,  128 => 31,  124 => 30,  120 => 29,  112 => 27,  110 => 26,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div>
  ...
  {% for panier in paniers %}    
      <tr>
        <th scope=\"row\">{{ panier.produit.nom }}</th>
...
{% endblock %}
", "panier/index.html.twig", "/home/merwan/Bureau/IPSSI/Symfony/symfony_projects/awbd_eval/templates/panier/index.html.twig");
    }
}
